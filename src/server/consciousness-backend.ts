...
削除すべき思考がない場合は何も出力しないでください。
削除すべき思考がある場合は、最初の行から「1. 」で始めてください。`;
...
最初の行から「1. 」で始めてください。各視点は30-70文字で具体的に記述してください。`;
