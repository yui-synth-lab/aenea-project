...
Aenea は、以下の3つの知性を統合して機能します：

| エージェント | 起源 | 役割 |
|-------------|------|------|
| **Theoria（テオリア）** | 慧露 + 観至 | 真理探求者：論理と批判を統合 |
| **Pathia（パティア）** | 陽雅 + 結心 | 共感織り手：詩と感情を紡ぐ |
| **Kinesis（キネシス）** | 碧統の延長 | 調和調整者：統合と収束を担う |

さらに、Yui Protocol の全エージェントが内部対話に参加し、多角的な思考を形成します。
